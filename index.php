...
<!--<script language='JavaScript'>window.open('http://www.chenico.com', 'geoflotante', '');</script>-->    <!--abrir de una vez otra pestaña-->
	...
	<div class="content">
		...
		<div class="portfolio" id="portafolio">
			<div class="container">
				...
				<div class="tabs tabs-style-bar slideanim">
					<nav>
						<ul>
							<li><a href="#section-bar-1" class="icon icon-box"><span>Páginas Web</span></a></li>
							<!--<li><a href="#section-bar-2" class="icon icon-display"><span>UI Kits</span></a></li>-->
							<li><a href="#section-bar-3" class="icon icon-upload"><span>Proyectos Android</span></a></li>
							<li><a href="#section-bar-4" class="icon icon-tools"><span>Fotografía</span></a></li>
						</ul>
					</nav>
					...
					<div class="content-wrap">
						...
						<section id="section-bar-3" class="slideanim">
							<h4>Aplicativos Modificados y Firmwares (ROM's) Editadas</h4>
							<div class="gallery-grids">
								<div class="col-md-4 gallery-top">
									<figure class="effect-bubba">
										<a href="http://ellibertador.260mb.net" target="_blank">
						...
						<section id="section-bar-4" class="slideanim">
							<h4>Mas que un hobby es un Arte</h4>
							<div class="gallery-grids">
								<div class="col-md-4 gallery-top">
									<figure class="effect-bubba">
								...
								<div class="col-md-4 gallery-top">
									<figure class="effect-bubba">
										<a href="images/g2.jpg" class="swipebox">
											...
											<figcaption>
												<p>Mas que fuertes, siempre firmes</p>
											</figcaption>
										</a>
									</figure>
								</div>
		...
		<div class="map slideanim">
			<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d127220.87714509304!2d-74.41051909941463!3d4.829608016026746!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8e3f7c5fb01452b9%3A0x931410cededabb4e!2sFacatativ%C3%A1%2C+Cundinamarca!5e0!3m2!1ses!2sco!4v1462326186216" width="800" height="600" frameborder="0" style="border:0" allowfullscreen></iframe>
		</div>
		<!-- //Map-iFrame -->
